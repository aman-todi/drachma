...
- [Social login providers](issues/10-social-login-providers.md): Google and Apple, alongside Supabase Auth's email/password; no GitHub at v1. Unblocks [Supabase project setup](issues/08-supabase-project-setup.md).
